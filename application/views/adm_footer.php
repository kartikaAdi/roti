      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2021 <a href="#">Kartika_Adi</a>.</strong> All rights reserved.
      </footer>
...
<!--<script src="http://code.jquery.com/jquery.js"></script>-->
    ...
    <script src="<?php echo base_url();?>assets/admin/validator/dist/validator.js"></script>
	...
	<script src="<?php echo base_url();?>assets/admin/summernote/dist/summernote.js" type="text/javascript"></script>
	 ...
	 <script type="text/javascript">
		...
		$('#submitBtn').click(function() {
		 ...
		 if($('#formfield').validator('valid'))
		 {
			 alert("as");
		 }
		  */
			//$("#success-alert").alert();var values = {};
			//retrieve all form input
			var values = {};
			var i=0;
			$.each($('#formfield').serializeArray(), function(i, field) {
				$('#val'+i).text(field.value);
