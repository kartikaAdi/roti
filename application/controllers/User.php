...
class User extends CI_Controller 
{
	...
	*/
	...
	//query
	var $ordQuery=" ORDER BY id_admin ";
	var $tableQuery="
						admin
						";
	var $fieldQuery="id_admin,uname,pass,level,foto"; //leave blank to show all field
						
	var $primaryKey="id_admin";
	var $updateKey="id_admin";
	...
	//save
	var $saveFormTitle="Tambah Data User";
	...
	*/
	...
	public function index()
	{
		...
		{
			$row->foto="<img src='".base_url()."/assets/admin/img/avatar/thumb/".$row->foto."' height='100px' width='auto' class='center-block'>";
		}
		...
		if(!empty($isEdit))
		{
			...
			foreach($render->result() as $row)
			{
				...
				$imgTemp="<h5><i>Click browse to change image</i></h5>
							<img src='".base_url()."/assets/admin/img/avatar/thumb/".$txtVal[4]."' height='200px' width='auto' >
							<input type='hidden' name='txtimg' value='".$txtVal[4]."'>";
		}
		else
		{	
