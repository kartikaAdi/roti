...
class Hpp extends CI_Controller 
{
	...
	*/
	...
	var $breadcrumbTitle="Data HPP";
	var $viewPage="HPPviewpage";
	var $addPage="HPPaddpage";
	...
	//save
	var $saveFormTitle="Tambah Data HPP";
	...
	//update
	var $editFormTitle="Edit Data HPP";
