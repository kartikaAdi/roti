...
class Overheadvariabel extends CI_Controller 
{
	...
	*/
	...
	var $mainTable="overheadvariabel";
	var $mainPk="id_overhead";
	var $viewLink="overheadvariabel";
	var $breadcrumbTitle="daftar overhead";
	var $viewPage="Overheadvariabelviewpage";
	var $addPage="Admaddpage";
	
	//query
	var $ordQuery=" ORDER BY id_overhead ";
	var $tableQuery="
						overheadvariabel
						";
	var $fieldQuery="id_overhead,nama_overhead,harga,jumlah"; //leave blank to show all field
						
	var $primaryKey="id_overhead";
	var $updateKey="id_overhead";
	...
	//view
	var $viewFormTitle="Data Overhead Variabel";
	...
	//save
	var $saveFormTitle="Tambah Data Overhead Variabel";
	...
	//update
	var $editFormTitle="Edit Data Overhead Variabel";
